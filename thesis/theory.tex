...
When two vertices are the endpoints of the same edge the vertices are said to be \emph{adjacent}:
...
One of the possible relations in a graph tuple is a function that assigns each vertex an identifying label:
...
Thus, the part consolidation graphs that act as the inputs to the two algorithms are labeled graphs, where the labels
