...
The steps of the coloring routine are as follows for a complete graph \(G_i\) of order \(k\) and a removed vertex
list \(S_i\) from tree \(i\), and an input graph \(G\) that is \chromatic{k}:
\begin{enumerate}
