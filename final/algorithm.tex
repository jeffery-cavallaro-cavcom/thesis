...
\item\label{step:sub:result1} If \(G\cdot uv\) is \colorable{k} then return true (Theorem~\ref{thm:recurse}).
...
\item\label{step:sub:result2} If \(G+uv\) is \colorable{k} then return true (Theorem~\ref{thm:recurse}).
