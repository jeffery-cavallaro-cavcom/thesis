...
The trick is to find the best ordering of the vertices in \(G\) so that the greedy algorithm gives the best
answer.  Clearly, there is at least one optimal ordering that will produce an exact result.  This is stated
in \propname~\ref{prop:greedy}.
